...
const ArtistCardView = ({ artist, isFollowed, handleFollow }) => {
  return (
    <div className="bg-primary px-2 py-2 pr-5 pl-5 font-bold text-xl flex justify-between items-center rounded-md">
